...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("HaxeDiepIo", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("HaxeDiepIo", null, null, null);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "1";
		app.meta["company"] = "InLiothixie";
		app.meta["file"] = "HaxeDiepIo";
		app.meta["name"] = "HaxeDiepIo";
